...
<body class="main-layout">
    <!-- loader  -->
    <div class="loader_bg">
        <div class="loader"><img src="landing/images/loading.gif" alt="#" /></div>
    </div>
    <!-- end loader -->
    <!-- header -->
    <header>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo"> <a href="index.html"><img src="landing/images/logo.jpg"
                                            alt="logo" /></a> </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="first-slide" src="landing/images/banner2.jpg" alt="First slide">
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img class="second-slide" src="landing/images/banner2.jpg" alt="Second slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                                <strong class="yellow_bold">Product </strong>
                ...
                <div class="carousel-item">
                    <img class="third-slide" src="landing/images/banner2.jpg" alt="Third slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                                <strong class="yellow_bold">Product </strong>
            ...
            <div class="white_bg">
                <div class="row">
                    <dir class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="for_box">
                            <i><img src="landing/icon/1.png" /></i>
                            <h3>Data recovery</h3>
                    ...
                    <dir class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="for_box">
                            <i><img src="landing/icon/2.png" /></i>
                    ...
                    <dir class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="for_box">
                            <i><img src="landing/icon/3.png" /></i>
                    ...
                    <dir class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="for_box">
                            <i><img src="landing/icon/4.png" /></i>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="service-box">
                        <i><img src="landing/icon/service1.png" /></i>
                        <h3>Fast service</h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="service-box">
                        <i><img src="landing/icon/service2.png" /></i>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="service-box">
                        <i><img src="landing/icon/service3.png" /></i>
                        <h3>Expert team</h3>
                        <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="service-box">
                        <i><img src="landing/icon/service4.png" /></i>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="service-box">
                        <i><img src="landing/icon/service5.png" /></i>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="service-box">
                        <i><img src="landing/icon/service6.png" /></i>
                        <h3>Award winning</h3>
                        <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p1.png" /></i>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p2.png" /></i>
                            <h3>Norton Internet Security</h3>
                            <span>$25.00</span>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p3.png" /></i>
                            <h3>Norton Internet Security</h3>
                            <span>$25.00</span>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p4.png" /></i>
                            <h3>Norton Internet Security</h3>
                            <span>$25.00</span>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p5.png" /></i>
                            <h3>Norton Internet Security</h3>
                            <span>$25.00</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p6.png" /></i>
                            <h3>Norton Internet Security</h3>
                            <span>$25.00</span>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="product-box">
                            <i><img src="landing/icon/p7.png" /></i>
                            <h3>Norton Internet Security</h3>
                            <span>$25.00</span>
                        </div>
                    </div>
                        ...
                        <div class="carousel-item active">
                            <div class="container">
                                <div class="carousel-caption text-bg">
                                    <div class="img_bg">
                                        <i><img src="landing/images/lllll.png" /><span>Jone Due<br><strong
